...
export interface VisitReport {
  ...
  // Detalhes Técnicos - Filtro Prensa (Abaixo do desenho)
  tipo_linha_linhas?: string;
  medidas_obtidas_da?: string;
  fonte_medidas?: string;
  modelo_placa?: string;
  pinos_superiores_tipo?: string;
  pinos_superiores_qtd?: string;
  pinos_superiores_diametro?: string;
  pinos_superiores_distancias?: string;
  alimentacao_tipo?: string;
  amarracoes_superior?: string;
  amarracoes_inferior?: string;
  amarracoes_lateral?: string;
  vedacao_tipo?: string;
  vedacao_material?: string;
  cabeceiras_inicial?: string;
  cabeceiras_final?: string;
